var shuffleSequence = seq("consent", "intro", "practice1", "sep", sepWith("sep", seq(randomize("practice"))), "post-practice", "setcounter", sepWith("sep", seq(randomize("picture-causal"))), "sr", "debrief");
